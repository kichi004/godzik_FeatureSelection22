...
def visualize_tree_classifier(file_name, output_name, depth_input = None):
    # read in data
    ...
    # generate classifier
    rfc = DecisionTreeClassifier(max_depth = depth_input)
...
def visualize_forest_classifier(file_name, output_name, depth_input = None):
    # read in data
    df = pd.read_csv(file_name)
    ...
    # generate classifier
    rfc = RandomForestClassifier(n_estimators = 10, max_depth = depth_input)
