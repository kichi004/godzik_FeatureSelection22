...
def loocv_rf_classifier(file_name):
    ...
    print(f'CV Random Forest Accuracy: {statistics.mean(scores_list)*100:.2f} (+/- {statistics.stdev(scores_list)*100:.2f})% for {scores_list.__len__()} samples\n')

# asks for the name of the dataset to be loaded
dataset_name = input("Enter the name of the csv file to find the accuracy for: ")
loocv_rf_classifier(dataset_name)
